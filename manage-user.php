            ...
            <tbody>
                <tr>
                    ...
                    <td style="font-weight: bold" class="text-manage">
                        <a href="" class="btn btn-primary butt" style="background-color: dodgerblue; cursor: pointer;">Change Password</a>
                        <a href="" class="btn btn-primary butt" style="background-color: #2dc653; cursor: pointer; color: black">Update Admin</a>
                        <a href="" class="btn btn-primary butt">Delete Admin</a>
                    </td>
                </tr>
                <tr>
                    <th scope="row">2.</th>
